...
arrayEsparso[3] =  "Elemento2";
arrayEsparso[7] = "Elemento3";
...
const arrayElementos = [2,5,4,6,8];
console.log("Elementos", arrayElementos);
arrayElementos[0] = 1;
console.log("Elemento alterado no index [0]", arrayElementos);
...
console.log("Array apos a alteração no primeiro indice", meuArray)
...
arrayVazio.push(9);
arrayVazio.push(5);
console.log(`array após ser adicionado: ${arrayVazio.join(', ')}`);
...
console.log('Fila após a exclusão: ', clinica)
