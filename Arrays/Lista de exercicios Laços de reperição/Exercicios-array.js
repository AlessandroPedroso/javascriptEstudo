...
const listaNumerosDobrados = executaOperacaoEmArray(listaNumero,dobraNumero);
...
const numerosAtividade5 = [6, 9, 12, 15, 18, 21];
...
numerosAtividade5.forEach(numero => {
  const resultado = numero * 3;
  console.log(resultado);
});

const indiceDoNumero18 = numerosAtividade5.findIndex(numero => numero === 18);
